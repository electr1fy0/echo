...
function buildPage(title: string, description: string, url: string): string {
...
<meta property="og:image" content="https://turnsout.xyz/thumb.jpg" />
<meta property="og:image:width" content="1200" />
<meta property="og:image:height" content="630" />
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="${safeTitle}" />
<meta name="twitter:description" content="${safeDesc}" />
<meta name="twitter:image" content="https://turnsout.xyz/thumb.jpg" />
</head>
<body>
...
export default async function middleware(
  ...
  try {
    ...
    return new Response(buildPage(displayName, description, pageUrl), {
