  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <div className="flex flex-col gap-2 mb-3">
        <div className="flex items-center justify-between border-b border-neutral-100 dark:border-neutral-800/80 pb-2">
          <div className="flex-1 min-w-0 mr-2">
            <button
              ...
              className={cn(
                "flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold transition-all cursor-pointer border shrink-0",
                showSettings
        ...
        {showSettings && (
          <div className="bg-neutral-50/90 dark:bg-neutral-900/60 p-4 rounded-2xl border border-neutral-200/60 dark:border-neutral-800/80 space-y-4 text-xs transition-all shadow-sm">
            
            {/* Sort & Scope Row */}
            <div className={cn("grid gap-3", user ? "grid-cols-2" : "grid-cols-1")}>
              {/* Sort Segment */}
              <div className="flex flex-col gap-1.5">
                <span className="font-semibold text-neutral-400 uppercase text-[9px] tracking-wider">Sort by</span>
                <div className="flex bg-neutral-100/80 dark:bg-neutral-900/60 p-0.5 rounded-lg border border-neutral-200/40 dark:border-neutral-800/40">
                  <button
                    ...
                    className={cn(
                      "flex-1 text-center py-1 rounded-md text-[10px] font-semibold transition-all cursor-pointer",
              ...
              {user && (
                <div className="flex flex-col gap-1.5">
                  <span className="font-semibold text-neutral-400 uppercase text-[9px] tracking-wider">Scope</span>
                  <div className="flex bg-neutral-100/80 dark:bg-neutral-900/60 p-0.5 rounded-lg border border-neutral-200/40 dark:border-neutral-800/40">
                    <button
                      type="button"
            ...
            {/* Type Pills */}
            <div className="flex flex-col gap-1.5">
              <span className="font-semibold text-neutral-400 uppercase text-[9px] tracking-wider">Post Type</span>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      column.postTypeFilter === type.key
                        ? "bg-neutral-900 border-neutral-900 text-white dark:bg-neutral-100 dark:border-neutral-100 dark:text-neutral-900 font-semibold"
            ...
            <div className="space-y-6 px-4 py-4">
              ...
              {chambers.filter((c) => !c.isJoined).length > 0 && (
                <div className="space-y-3">
                  <h4 className="text-[10px] font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-wide px-1">
                    Suggested Chambers
                  </h4>
                  ...
                  <Link
                    to="/chambers"
                    className="block text-center text-xs font-semibold text-neutral-600 dark:text-neutral-400 hover:text-[#ff5a1f] transition-colors pt-2"
                  >
