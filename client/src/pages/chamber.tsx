...
import { useJoinChamber, useLeaveChamber, useListChambers } from "@/hooks/use-chamber";
...
export function ChamberPage() {
    ...
    const { data: questions = [] } = useQuestionsQuery(0, 50, "time_created", undefined, chamberId);
