    ...
    return (
        ...
        >
            <div className="flex items-start gap-3">
                <UserAvatar src={item.author.avatar} name={item.author.username} className="size-8" />
    ...
    return (
        <div className="max-w-[40rem] w-full mt-40 space-y-8 mb-40 relative px-4 pb-20 md:pb-0">
            <div className="relative">
                ...
                />
                <Input
                    placeholder="Search for questions, chambers, or replies..."
                ...
                <>
                    <div className="space-y-3">
                        <div className="flex items-center justify-between px-1">
                            ...
                            <Button variant="ghost" size="sm" className="text-xs h-7 gap-1" onClick={() => navigate("/chambers")}>
                                View all
