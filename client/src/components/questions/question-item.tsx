...
const TriggerWrapper = ({
  ...
  if (isEditing) {
    return (
      <div
        className="flex flex-1 items-start justify-between gap-3 p-4 text-left text-sm font-normal border border-transparent relative outline-none cursor-default"
      >
        {children}
      </div>
    );
