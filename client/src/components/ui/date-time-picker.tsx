...
export function DateTimePicker({
  ...
  const handleDateSelect = (selected: Date | undefined) => {
    ...
    if (existing) {
      ...
      selected.setHours(h24, selMin, 0, 0);
    }
  ...
  const displayText = date ? formatDisplay(date) : null;
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverPopup className="w-[300px] p-0 space-y-3">
        <Calendar
          mode="single"
          selected={date || undefined}
          onSelect={handleDateSelect}
        />
        <div className="border-t border-neutral-200 dark:border-neutral-800 pt-3 flex items-center justify-center">
